 ...
 *
 *   // network
 *   CPhaseNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CPhaseNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: PhaseNetwork
// //   -- signature requirements : Key1(User)
// class CPhaseNetworkVariable : public CGovernanceObject
// {
// private:
