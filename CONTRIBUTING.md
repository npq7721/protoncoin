...
The following applies to code changes to the Phase Core project (and related projects such as libsecp256k1), and is not to be confused with overall Phase Network Protocol consensus changes.
...
Where a patch set proposes to change the Phase consensus, it must have been discussed extensively on the mailing list and IRC, be accompanied by a widely discussed BIP and have a generally widely perceived technical consensus of being a worthwhile change based on the judgement of the maintainers.
